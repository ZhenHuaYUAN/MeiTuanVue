<template>
  <div class="m-nav">
    <ul class="nav">
      ...
      <li class="list bd">
        <nuxt-link to="/centrer">商家中心</nuxt-link>
        <dl>
          <dd>
            <nuxt-link to="userCenter">登录商家中心</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="userCenter">我想合作</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="userCenter">免费手机开店</nuxt-link>
          </dd>
          <dd>
            <nuxt-link to="userCenter">商家申请开票</nuxt-link>
          </dd>
        </dl>
      </li>
      <li class="list site">
